...
internal static class Tune
{
    ...
    // depth zoomies
    // ===========================================================================
    [Tune("ZT_ZOOMIES", 0, 1, 1, "zoomies")] public static int Zoomies = 1;
    ...
    [Tune("ZT_LMR_CUTNODE", 0, 2, 1, "lmr-flags")] public static int LmrCutNode = 1;
    ...
    [Tune("ZT_LATE_CUTCHILD", 0, 1, 1, "lmr-flags")] public static int LateCutChild = 1;
